...
INSERT INTO Orders VALUES 
(4, 1, '2023-04-15', 499.99);  -- Order 4: Customer 1 purchased something else

INSERT INTO Orders VALUES 
(5, 2, '2023-05-10', 349.99);  -- Order 5: Customer 2 purchased something else
...
--Query: Top-selling category by revenue
SELECT TOP 1
	p.category,
...
--Query: Number of orders per customer
SELECT
	c.first_name,
	c.last_name,
